...
NETS = {'ResNet-101': ('ResNet-101',
                  'resnet101_rfcn_ohem_iter_30000.caffemodel'),
        'ResNet-50': ('ResNet-50',
...
if __name__ == '__main__':
    ...
    caffemodel = os.path.join(cfg.DATA_DIR, 'testmodels',
    ...
    im_names = ['lc1.jpg','lc2.jpg','lc3.jpg','mall1.jpg','mall2.jpg','mall3.jpg','mall4.jpg','mall5.jpg']
